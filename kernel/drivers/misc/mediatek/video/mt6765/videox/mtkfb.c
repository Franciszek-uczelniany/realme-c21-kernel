...
static int mtkfb_probe(struct platform_device *pdev)
{
	...
	if ((!strcmp(mtkfb_find_lcm_driver(),"nt36525b_hlt_psc_hdp_dsi_vdo_lcm")) || (!strcmp(mtkfb_find_lcm_driver(),
		...
		"ili9882n_txd_inx")) || (!strcmp(mtkfb_find_lcm_driver(),
		"nt36525b_hlt_boe")) || (!strcmp(mtkfb_find_lcm_driver(),
		"ili9882n_mn228_txd_inx"))|| (!strcmp(mtkfb_find_lcm_driver(),
		"hx83102d_txd_inx"))|| (!strcmp(mtkfb_find_lcm_driver(),
		"ft8006s_hlt_boe")) || (!strcmp(mtkfb_find_lcm_driver(),
		"hx83102d_truly_truly")) || (!strcmp(mtkfb_find_lcm_driver(),
		"ft8722_hlt_boe_eighth")) || (!strcmp(mtkfb_find_lcm_driver(),
		"ft8006saa_truly_truly"))) {
