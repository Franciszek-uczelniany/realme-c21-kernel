...
static int pedo_minute_data_report(struct data_unit_t *input_event)
{
    ...
    event.word[0] = input_event->oppo_data_t.pedo_minute_event.step_count;
    event.word[1] = input_event->oppo_data_t.pedo_minute_event.report_count;
    event.word[2] = input_event->oppo_data_t.pedo_minute_event.move_status;
    event.word[3] = input_event->oppo_data_t.pedo_minute_event.time_gap;
    event.word[4] = input_event->oppo_data_t.pedo_minute_event.step_run_count;
    event.word[5] = input_event->oppo_data_t.pedo_minute_event.step_walk_count;
...
static int pedo_minute_recv_data(struct data_unit_t *event, void *reserved)
{
    ...
    PEDO_MINUTE_LOG("pedo_minute recv data, flush_action = %d, step_count value = %d,timestamp = %lld\n",
        event->flush_action, event->oppo_data_t.pedo_minute_event.step_count, (int64_t)event->time_stamp);
